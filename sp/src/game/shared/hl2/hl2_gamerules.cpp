...
ConVar	sk_plr_dmg_assaultrifle	("sk_plr_dmg_assaultrifle", "0", FCVAR_REPLICATED);
ConVar	sk_npc_dmg_assaultrifle	("sk_npc_dmg_assaultrifle", "0", FCVAR_REPLICATED);
ConVar	sk_max_assaultrifle		("sk_max_assaultrifle", "0", FCVAR_REPLICATED);
